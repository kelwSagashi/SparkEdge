...
// import { INodeType, INodeTypeData, KnownNodesAndCredentials, Types } from "nmg8-workflow";
...
// 	known: KnownNodesAndCredentials = { nodes: {} };
...
// 		const tempNode = this.loadClass<INodeType>(filePath);
