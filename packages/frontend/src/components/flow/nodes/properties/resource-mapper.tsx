...
type NodePropertiesOptionsType = Extract<INodeProperties, { type: 'resourceMapper' }>;

export interface NodeResourceMapperProps {
    // handleChangeText: (value: IDataObject, property: NodePropertiesOptionsType) => void;
    property: NodePropertiesOptionsType;
}

export default function NodeResourceMapperProperty({
    // handleChangeText,
    property
}: NodeResourceMapperProps) {
